 ...
 */
define(['N/ui/serverWidget', 'N/file', 'N/log', 'N/https'], function(serverWidget, file, log, https) {
    function onRequest(context) {
        if (context.request.method === 'GET') {

                // Initialize the form
                var form = serverWidget.createForm({ title: 'My Custom Form' });
                
                // Load the HTML file from the file cabinet
                var formFile = file.load({ id: '14233' });  // Replace with your file's ID
            ...
            try {
              ...
              context.response.write('File uploaded to row ID ' + rowId + '. Response: ' + fileUploadResponse.body);
