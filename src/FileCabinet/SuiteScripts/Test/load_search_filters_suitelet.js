...
// Searches
        ...
        var searchConfigurations = [
            ...
            },
            {
                ...
                fields: [{id: 'trandate', type: serverWidget.FieldType.DATE, label: 'Date', summary: 'GROUP'}, 
                {id: 'quantity', type: serverWidget.FieldType.INTEGER, label: 'Units Sold', summary: 'search.Summary.SUM'}, 
            ]
            },
        ];
