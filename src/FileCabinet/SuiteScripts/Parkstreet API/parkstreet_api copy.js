  ...
  function onRequest(context) {
    if (context.request.method === 'GET') {
      ...
      if (dateFrom && dateTo) {
        ...
        var cashApiUrl =
          'https://navigator.parkstreet.com/router.php/public_apis/get_data/cash_report?token=' + cashToken;
        ...
        var expenseApiUrl =
          'https://navigator.parkstreet.com/router.php/public_apis/get_data/expense_report?token=' + expenseToken;
        ...
        if (invoiceResponse.body) {
          ...
          if (invoiceData.data && invoiceData.data.length > 0) {
            ...
            form.addField({
              ...
              type: serverWidget.FieldType.INLINEHTML,
              label: 'Error',
              defaultValue: '<div>Please provide both From Date and To Date.</div>',
            });
          }
        }
        context.response.writePage(form);
