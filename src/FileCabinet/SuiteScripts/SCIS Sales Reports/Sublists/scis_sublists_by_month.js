define(['N/ui/serverWidget', 'N/log', '../Searches/scis_search_by_month.js'], function(serverWidget, log, searchByMonth) {
    function createSublist(form) {

        var summaryResults = searchByMonth.runSalesSearch();       
 
 // SCIS Sales Sublist 
                var sublist = form.addSublist({
                    id: 'custpage_sales_by_month',
